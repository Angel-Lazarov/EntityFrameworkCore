namespace TestProject
{
    ...
    public class StartUp
    {
        ...
        private static void ImportEntities(TestProjectContext context, string baseDir, string exportDir)
        {
            var creators =
        ...
        private static void ExportEntities(TestProjectContext context, string exportDir)
        {
        ...
        private static void ResetDatabase(TestProjectContext context, bool shouldDropDatabase = false)
        {
